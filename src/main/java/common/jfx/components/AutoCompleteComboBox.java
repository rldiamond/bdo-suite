...
public class AutoCompleteComboBox implements EventHandler<KeyEvent> {
    ...
    public static void install(final ComboBox comboBox) {
        new AutoCompleteComboBox(comboBox);
    }

    private AutoCompleteComboBox(final ComboBox comboBox) {
    ...
    private AutoCompleteComboBox(final ComboBox comboBox, Integer sid) {
        this.comboBox = comboBox;
        this.data = comboBox.getItems();
        this.sid = sid;
